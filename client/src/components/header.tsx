...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full bg-deep-black/80 backdrop-blur-md border-b border-gray-800 z-40">
      <nav className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          <div className="text-xl font-bold bg-gradient-to-r from-purple to-pink bg-clip-text text-transparent">
            Medha Ahuja
          </div>
          
          {/* Desktop Navigation */}
          <div className="hidden md:flex space-x-8">
            <button onClick={() => scrollToSection('home')} className="hover:text-purple transition-colors duration-300">Home</button>
          ...
          <div className="hidden md:flex space-x-4">
            <a href="https://linkedin.com/in/medha-ahuja" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 space-y-4">
            <button onClick={() => scrollToSection('home')} className="block hover:text-purple transition-colors duration-300">Home</button>

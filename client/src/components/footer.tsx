    ...
    <footer className="bg-gray-900 border-t border-gray-800 py-12">
      <div className="container mx-auto px-6">
        <div className="text-center">
          <div className="text-2xl font-bold bg-gradient-to-r from-purple to-pink bg-clip-text text-transparent mb-4">
            Medha Ahuja
          </div>
          <p className="text-gray-400 mb-6">AI-Focused Product Manager</p>
          ...
          <div className="text-gray-500 text-sm">
            © 2025 Medha Ahuja. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
